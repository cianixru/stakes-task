...
import { getColumnInformation, getColumnProperties, getTableMetadata, column } from './decorators';
...
// let beforeIncrementTransform = undefined as undefined | ((item: any, typedQueryBuilder: TypedQueryBuilder<{}, {}>) => any);

// export function beforeIncrementTransform<T>(f: (item: T, typedQueryBuilder: TypedQueryBuilder<{}, {}>) => T) {
//     beforeIncrementTransform = f;
// }
